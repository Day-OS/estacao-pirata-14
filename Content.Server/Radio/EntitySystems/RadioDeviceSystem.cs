...
public sealed class RadioDeviceSystem : EntitySystem
{
    ...
    private void OnReceiveRadio(EntityUid uid, RadioSpeakerComponent component, ref RadioReceiveEvent args)
    {
        ...
        var message = args.ChatMsg.Message; // The chat system will handle the rest and re-obfuscate if needed.
        _chat.TrySendInGameICMessage(uid, message.Message, InGameICChatType.Whisper, ChatTransmitRange.GhostRangeLimit, nameOverride: name, checkRadioPrefix: false, languageOverride: args.Language);
